...
const busPrices = {
    "Jakarta - Terminal Pulo Gebang": { economy: 300000, business: 450000, executive: 600000 },
    "Jakarta - Terminal Kampung Rambutan": { economy: 280000, business: 430000, executive: 580000 },
    "Bandung - Terminal Leuwi Panjang": { economy: 250000, business: 400000, executive: 550000 },
    ...
    "Badung - Terminal Mengwi": { economy: 0, business: 0, executive: 0 },
    "Denpasar - Terminal Ubung": { economy: 10000, business: 20000, executive: 31000 },
...
function updatePrice() {
    ...
    if (selectedTerminal && selectedClass) {
        ...
        if (price !== undefined) {
            priceResult.innerHTML = `Price from ${selectedTerminal} to Badung - Terminal Mengwi: <br><strong>IDR ${price.toLocaleString()}</strong>`;
        } else {
